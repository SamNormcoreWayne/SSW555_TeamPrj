...
class Test_us30_list_living_married(unittest.TestCase):
    """Tests conducted on file 'what_a_mass.ged'"""

    def test_us30_list_living_married(self):
        """Test us30_list_living_married()"""
        self.assertEqual(a.us30_list_living_married(), ['@I1@', '@I4@', '@I6@', '@I7@', '@I8@', '@I9@', '@I10@', '@I11@', '@I12@', '@I13@',
